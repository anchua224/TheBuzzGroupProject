...
//             fail("Fail insert");
//         }
//         assertFalse(mDatabase.mIdeaTable.insertIdea("subject", "message", 1)==0);
//         ResultSet rs;
//         int id=-1;
//         String subject="";
//         String message="";
...
//                  id=rs.getInt("id");
//             }
//             assertFalse(mDatabase.mIdeaTable.updateIdea(id,"subject1", "message1", 0)==-1);
//             //select from last_insert_row
...
//     }
//     /**
//      * test program to add a user to usertable
//      */
...
//     //     assert(mDatabase != null);
//     //     try{
//     //         mDatabase.mUserTable=new UserTable(mDatabase.mConnection);
//     //     }catch(Exception e){
//     //         fail("Fail insert to User");
//     //     }
//     //     assertFalse(mDatabase.mUserTable.insertUser("email", "name", "GI", "SO", "note")==0);
//     //     ResultSet rs;
//     //     int id=-1;
//     //     String email"";
//     //     String name="";
