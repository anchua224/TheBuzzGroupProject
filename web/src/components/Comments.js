...
export default function Comments(props) {
  ...
  const getComments = async () => {
    ...
    axios.get(`https://cse216-fl22-team14-new.herokuapp.com/ideas/${props.idea_id}/comment`)
      .then(response => {
  ...
  return (
    <div>
      <button className="comment-button"onClick={() => setIsOpen(true)}> Add Comment</button>
      <AddComment
      ...
      />
      <hr></hr>
      <b className='description'>Comments:</b>
